...
local main1 = Tabs.general:AddLeftTabbox() do
    local farm = main1:AddTab("Main") do
        farm:AddToggle("Farm_Level",{Text = "Auto Farm Level",Default = false}):OnChanged(function ()
            _G.AutoFarm = Toggles.Farm_Level.Value
            StopTween(_G.AutoFarm)
        end)
        farm:AddToggle("Farm_New",{Text = "Auto Farm New World",Default = false}):OnChanged(function ()
            if W then
                _G.AutoSecondSea = Toggles.Farm_New.Value
                StopTween(_G.AutoSecondSea)
            elseif W2 then
                _G.AutoThirdSea = Toggles.Farm_New.Value
...
local main2 = Tabs.general:AddRightTabbox() do
    local setting = main2:AddTab("Weapon/FastAttack") do
        ...
        setting:AddDropdown('Select_Fast', {
            Values = MIo,
            Default = 2,
            Multi = false,
    ...
    local settings = main2:AddTab("Settings") do
        settings:AddToggle('Toggle_Bring',{
            Text = 'Bring Mob',
            Default = true,
        }):OnChanged(function ()
            _G.BringMonster = Toggles.Toggle_Bring.Value
        end)
        settings:AddToggle('SetSpawn',{Text = 'Auto Set Spawn Point',Default = true}):OnChanged(function ()
