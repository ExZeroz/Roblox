...
function library:Window(text,text2,text3,logo,keybind)
	...
	ToggleImgUi.Image = "rbxassetid://10635436956"
...
Strokefps.Color = Color3.fromRGB(175,238,238)
...
ImageLabelfps.Image = "rbxassetid://10635436956"
...
Framefps.MouseLeave:Connect(function()
	...
	function uitab:Tab(text,logo1)
		...
		function main:Toggle(text,Imgidicon,config,callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(224,255,255)
			...
			Circle.BackgroundColor3 = Color3.fromRGB(224,255,255)
...
local ScreenGui = Instance.new("ScreenGui")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(10635436956)

_G.Color = Color3.fromRGB(224,255,255)

local win = library:Window("MAKO",[[HUB]],[[Blox Fruit]],"10635436956",Enum.KeyCode.RightControl)
local Main = win:Tab("Main",[[7040391851]])
local Combat = win:Tab("Combat",[[7251993295]])
local Stats = win:Tab("Stats",[[7252023075]])
local Teleport = win:Tab("Teleport",[[7040347038]])
local Dungeon = win:Tab("Dungeon",[[6034684949]])
local DevilFruit = win:Tab("Fruit",[[6023426909]])
...
Main:Toggle("Very Fast Attack [OMG]","6022668898",nil,function(value)
...
spawn(function()
 ...
 Main:Dropdown("SelectFast attack",{
            "Normal fast attack",
            "Hard fast attack",
            "Very fast attack",
            "Super fast attack"
...
Main:Toggle("SelectMode","6022668898",false,function(value)
        _G.Fast = value
        if _G.Fast == true then
                if _G.SelectFast == "Normal fast attack" then
                    getgenv().FastAttack = value
                elseif _G.SelectFast == "Hard fast attack" then
                   _G.FastAttack2 = value
                elseif _G.SelectFast == "Super fat attack" then
...
while cac() do 
	AttackNoCD()
                ...
                elseif _G.SelectFast == "Super very fast attack(kick98%)" then
                              local SuperFastMode2 = value -- à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¹€à¸›à¹‡à¸™à¸ˆà¸£à¸´à¸‡à¸–à¹‰à¸²à¸„à¸¸à¸“à¸•à¹‰à¸­à¸‡à¸à¸²à¸£à¹‚à¸ˆà¸¡à¸•à¸µ Super Super Super Fast (à¹€à¸Šà¹ˆà¸™à¸à¸²à¸£à¸†à¹ˆà¸²à¸—à¸±à¸™à¸—à¸µ) à¹à¸•à¹ˆà¸ˆà¸°à¸—à¸³à¹ƒà¸«à¹‰à¹€à¸à¸¡à¹€à¸•à¸°à¸„à¸¸à¸“à¸¡à¸²à¸à¸à¸§à¹ˆà¸²à¹‚à¸«à¸¡à¸”à¸›à¸à¸•à¸´
             _G.SuperFastMode2 = value
...
Main:Seperator("Dough King")

Main:Toggle("Auto Dough King","6022668898",_G.Auto_Open_Dough_Dungeo,function(value)
...
Main:Toggle("Auto Dought Boss","6022668898",_G.AutoDoughtBoss,function(value)
...
Main:Toggle("Auto Rainbow Haki","6022668898",_G.Auto_Rainbow_Haki,function(value)
...
Main:Toggle("Auto Rengoku","6022668898",_G.AutoRengoku,function(value)
...
Main:Toggle("Auto Farm Ectoplasm","6022668898",_G.AutoEctoplasm,function(value)
...
Main:Toggle("Auto Yama","6022668898",_G.AutoYama,function(value)
    _G.AutoYama = value
...
Main:Toggle("Auto Evo Race","6022668898",_G.Auto_EvoRace,function(value)
...
DevilFruit:Toggle("Auto Buy Fruit Sniper","6022668898",_G.AutoBuyFruitSniper,function(value)
...
DevilFruit:Toggle("Auto Store Fruit","6022668898",_G.AutoStoreFruit,function(value)
