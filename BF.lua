...
local Window = Library:CreateWindow({Title = 'Reso Hub | Blox Fruits | Free Scripts',Center = true, AutoShow = true,})
local Tabs = {Main = Window:AddTab('General'),Stat = Window:AddTab('Stats'),['UI Settings'] = Window:AddTab('UI Settings'),}
local column2 = Tabs.Main:AddLeftTabbox() do
    local section2 = column2:AddTab('Main') do
        section2:AddToggle('FarmLevel', {Text = 'Auto Farm Level',Default = false,}):OnChanged(function ()
            _G.AutoFarm = Toggles.FarmLevel.Value
...
local column = Tabs.Main:AddRightTabbox() do
    local section3 = column:AddTab('Settings') do
        WeaponList = {}
        ...
        section3:AddDropdown('SelectWapon', {Values = WeaponList,Text = 'Select Weapon'}):OnChanged(function ()
            _G.SelectWeapon = Options.SelectWapon.Value
        end)
        section3:AddButton('Refresh Weapon', function()
            WeaponList = {}
            ...
            Options.SelectWapon.Values = WeaponList
			Options.SelectWapon:SetValues()
			Options.SelectWapon:SetValue(nil)
        end)
        section3:AddToggle('SetSpawn', {Text = 'Auto Set Spawn Points',Default = true,}):OnChanged(function()
        ...
        section3:AddToggle('Bring', {Text = 'Bring Mob',Default = true,}):OnChanged(function ()
            _G.BringMonster = Toggles.Bring.Value
        end)

        section3:AddToggle('Fast', {Text = 'Fast Attack',Default = true,}):OnChanged(function ()
            _G.FastAttack = Toggles.Fast.Value
        end)
...
local Tabstat = Tabs.Stat:AddLeftTabbox() do
    local stat = Tabstat:AddTab('Add Stats') do
        ...
        stat:AddToggle('Defense', {Text = 'Add Defense',Default = false,}):OnChanged(function ()
            _G.Auto_Gun = Toggles.Defense.Value
        end)
