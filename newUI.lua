...
function library:Xeris()
	...
	Title.Position = UDim2.new(0.0882352963, 0, 0, 10)
	Title.Size = UDim2.new(0, 483, 0, 31)
	Title.Font = Enum.Font.GothamMedium
	Title.Text = "Xeris Hub Community"
	...
	Desc.Position = UDim2.new(0.0882352963, 0, 0, 25)
	Desc.Size = UDim2.new(0, 483, 0, 31)
	Desc.Font = Enum.Font.GothamMedium
	Desc.Text = "THE BEST SCRIPT FOR EVERYONE"
    ...
    function tabs:Tab(Name, icon)
        ...
        Tab.MouseButton1Click:Connect(
            function()
                ...
                TweenService:Create(
                    ImageLabel,
                    TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    {ImageColor3 = Color3.fromRGB(30, 215, 96)}
                ):Play()
                TweenService:Create(
                    ImageLabel,
                    TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        ...
        function sections:Section(Name,side)
            ...
            Line.Name = "Line"
            Line.Parent = Top_2
            Line.BackgroundColor3 = Color3.fromRGB(30, 215, 96)
            ...
            function functionitem:ButtonTog(Title, default, callback)
                ...
                if default then
                    Button_2.BackgroundColor3 = Color3.fromRGB(30, 215, 96)
                else
                    Button_2.BackgroundColor3 = Color3.fromRGB(25, 20, 20)
                end
                ...
                if default then
                    TweenService:Create(
                        ...
                        {
                            BackgroundColor3 = state and Color3.fromRGB(30, 215, 96) or Color3.fromRGB(25, 20, 20)
                        }
                    ):Play()
                    callback(default)
                    Tgs = default
            ...
            function functionitem:Toggle(Name, default, callback)
                ...
                MainToggle_3.ImageColor3 = Color3.fromRGB(30, 215, 96)
    ...
    for i, v in next, Scroll_Items:GetChildren() do
        ...
        v:Destroy()
            ...
            function functionitem:Slider(Name, min, max, default, callback)
                ...
                SliderValueFrame1.BackgroundColor3 = Color3.fromRGB(30, 215, 96)
                ...
                SliderValueFrame2.BackgroundColor3 = Color3.fromRGB(30, 215, 96)
