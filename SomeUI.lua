...
do local GUI = game.CoreGui:FindFirstChild("SOMEXHUB")
    ;if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(255, 160, 0)
   end 
end
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id=8774806287"..tostring(logo)
...
local NameHub2 = Instance.new("TextLabel")
	...
	NameHub2.Text = "|"
	NameHub2.TextColor3 = Color3.fromRGB(255, 160, 0)
